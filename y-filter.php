...
<body style="background: url(&quot;assets/img/pad.png&quot;);">
    ...
    <div class="container">
        <nav class="navbar navbar-light navbar-expand navigation-clean" style="background: url(&quot;assets/img/pad.png&quot;);">
            <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a class="nav-link disabled" href="#" style="color: rgb(255,255,255);font-family: Alata, sans-serif;font-size:12px;">Genre</a></li>
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#" style="color: rgb(255,255,255);font-family: Alata, sans-serif;font-size:12px;">All</a>
                            ...
                            <a class="dropdown-item" href="cat.php?edt=<?php echo 'Drama'?>">Drama</a>
                        
                        </div>
                        </li>
                        <li class="nav-item"><a class="nav-link disabled" href="#" style="color: rgb(255,255,255);font-family: Alata, sans-serif;font-size:12px;">Year</a></li>
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#" style="font-family: Alata, sans-serif;color: rgb(255,255,255);font-size:12px;">All</a>
                            <div class="dropdown-menu" style="font-family: Alata, sans-serif;font-size:12px;">
        ...
        <nav class="navbar navbar-light navbar-expand navigation-clean" style="background: url(&quot;assets/img/pad.png&quot;);">
            <div class="container"><button class="navbar-toggler" data-toggle="collapse"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
    ...
    <?PHP
              ...
              if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                ...
                WHERE bin='0'
                AND year BETWEEN $year ORDER BY title ASC 
...
<?php
                ...
                ?>
                <h3 style="color:var(--yellow);text-align:center;">No <?php echo $rows['genre'] ?> Movies found.</h3>
                <?php
              } ?>
        </ul>
    </div>
    <div class="container"style="text-align:center">
<div style='padding: 10px 20px 0px; border-top: dotted 0px #CCC;'>
