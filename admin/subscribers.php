...
use PHPMailer\PHPMailer\PHPMailer;
  ...
  $q=mysqli_query($conn,"select * from subscriber WHERE subscriber_id='$subid'");
  ...
  if(isset($_POST['send']))
  {
    ...
    $mail->SMTPAuth = true;
    $mail->Username = "vehiclepoolingsystem@gmail.com";
    $mail->Password = 'Vehicle2021';
    $mail->Port = 465; //587
    ...
    if ($mail->send()) {
        ...
        echo '<script type="text/javascript">alert("notification sent."); window.location = "subscribers.php";</script>';
        exit;
    } else {
        $status = "failed";
...
<body id="page-top">
    <div id="wrapper">
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--orange);font-family: Alata, sans-serif;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="subscribers.php?edt=<?php echo $rows['admin_id'] ?>" style="font-size: 16px;"><i class="fa fa-user"></i><span style="font-weight: 4;">Subscribers</span></a></li>
                </ul>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" style="background: url(&quot;assets/img/pad.png&quot;);">
                ...
                <div class="container-fluid" style="font-family: Alata, sans-serif;font-weight: 4;background: url(&quot;assets/img/pad.png&quot;);">
                    <h4 class="text-dark mb-4">Subscribers</h4>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <div>
                                <div class="modal fade" role="dialog" tabindex="-1" id="myModal" >
                                    <div class="modal-dialog" role="document"style="padding-top:200px;text-align:center">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 style="font-size: 16px;">send an arlet</h4><button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
                                            </div>
                                            <div class="modal-body">
                                                <p class="text-center text-muted" style="color: var(--dark);">Notifying Message </p>
                                                <form class="custom-form" style="border-color: var(--orange);font-size: 13px;"   method="post">
                                             
                                                    <div class="form-group"><label>Message</label>
                                                    <textarea class="form-control" placeholder="Enter message here" wrap="soft" autocomplete="off" spellcheck="true" required="" name="message" minlength="0" maxlength="100000"></textarea></div>
                                                    <div class="form-group"><select name="movie" required="" class="form-control">
                                                    <?PHP
     ...
     while ($row=mysqli_fetch_array($re)) {
                                                          ?>
                                                            <option value="<?php echo $row['title'].'-'.$row['year']?>"><?php echo $row['title'].'-'.$row['year']?></option>
...
<?php
                                                  ...
                                                  ?>
                                                    ...
                                                    <button class="btn btn-light submit-button" type="submit" name="send" style="background: url(&quot;assets/img/pad.png&quot;);color: rgb(255,255,255);font-weight: 4;font-size: 13px;">Send</button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
...
<table class="table table-hover table-bordered results" style="font-size:10px;">
  <thead style="background-color:var(--orange);color:white;Font Weight:400;font-size:13px;">
    <tr>
      ...
      <th class="col-md-5 col-xs-5" style="font-weight: 4;border:none;">Email</th>
  ...
  <?PHP
              ...
              if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                ...
                $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `subscriber`");
  ...
  <?php
    ...
    <tr>
      ...
      <td style="font-weight: 4;border:none;"><?php echo $rows['email']; ?></td>
        <td style="font-weight: 4;border:none;"><a class="btn btn-sm" role="button" data-toggle="modal" href="#myModal"  style="background: url('assets/img/pad.png');color: rgb(255,255,255);font-weight: 4;font-size: 13px;" href="remove-temporary.php?edt=<?php echo $rows['movie_id'] ?>">Notify</a><br><br>
