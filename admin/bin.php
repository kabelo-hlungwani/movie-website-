        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0" style="background: var(--orange);font-family: Alata, sans-serif;">
            <div class="container-fluid d-flex flex-column p-0"><a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
                ...
                <ul class="navbar-nav text-light" id="accordionSidebar">
                    ...
                    <li class="nav-item"><a class="nav-link " href="table.php?edt=<?php echo $data['admin_id'] ?>" style="font-size: 16px;"><i class="fas fa-table"></i><span style="font-weight: 4;">Movies</span></a></li>
                    <li class="nav-item"><a class="nav-link active" href="bin.php" style="font-size: 16px;"><i class="fa fa-trash-o"></i><span style="font-weight: 4;">Recycling Bin</span></a></li>
                ...
                <div class="container-fluid" style="font-family: Alata, sans-serif;font-weight: 4;background: url(&quot;assets/img/pad.png&quot;);">
                    ...
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <div><p   data-toggle="modal"  style="color:var(--dark);">Removed Movies</p>
...
<table class="table table-hover table-bordered results" style="font-size:10px;">
  ...
  <?PHP
              ...
              if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                ...
                $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `film` where bin='1'");
  ...
  <?php
    ...
    <tr>
      ...
      <td style="font-weight: 4;border:none;"><?php echo $rows['genre']; ?></td>
        ...
        <td style="font-weight: 4;border:none;"><a class="btn btn-light submit-button"  style="background: url('assets/img/pad.png');color: rgb(255,255,255);font-weight: 4;font-size: 13px;" href="delete.php?edt=<?php echo $rows['movie_id'] ?>">Delete</a><br><br>
        <a class="btn btn-light submit-button" type="submit" style="background: url('assets/img/pad.png');color: rgb(255,255,255);font-weight: 4;font-size: 13px;" href="restore.php?edt=<?php echo $rows['movie_id']?>" >Restore</a>
    </td>
    </tr>
    <?php
       $x++;           
