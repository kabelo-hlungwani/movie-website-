...
<body style="background: url(&quot;assets/img/pad.png&quot;);">
    ...
    <p style="color: var(--yellow);font-family: Alata, sans-serif;text-align: center;font-size: 18px;"><a href="movie-list.php" style="color: var(--yellow);">Back To Movie</a>&nbsp;&gt;&gt; All <?php echo $cat ?> Movies</p>
    <div class="container">
    ...
    <?PHP
              ...
              WHERE film.genre='$cat' and bin='0' 
