...
.pagination>.active>span:hover{z-index:3;color:#fff;cursor:default;background-color:var(--yellow);border-color:var(--yellow)}
        ...
        <div class="container"><a class="navbar-brand" href="#" style="color: rgb(255,255,255);font-family: Alata, sans-serif;"><span style="color: var(--yellow);font-family: Aladin, cursive;"></span><span style="color: var(--white);font-family: Alata, sans-serif;font-weight: 400;">Mzansi</span><span style="color: var(--yellow);font-family: Aladin, cursive;font-weight: 400;"><span style="text-decoration: underline;">Movies</span></span></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1" style="background: url(&quot;assets/img/pad.png&quot;), #141414;border-radius: 0px;border-top-width: 0px;border-top-color: rgb(0,0,0);border-right-color: rgba(27,22,22,0.3);border-bottom-color: rgba(27,22,22,0.3);border-left-color: rgba(27,22,22,0.3);"><span class="sr-only">Toggle navigation</span><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 20 20" fill="none" style="color: var(--yellow);font-size: 25px;">
            ...
            <div class="collapse navbar-collapse" id="navcol-1" style="font-family: Alata, sans-serif;">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="#" style="color: var(--white);">Movies</a></li>
                    <li class="nav-item"><a class="nav-link" href="donate.php" style="color: var(--white);">Donate</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <h1 style="font-family: Alata, sans-serif;color: rgb(255,255,255);font-size: 22px;text-align: center;">Movies&nbsp;<i class="fas fa-film" style="font-size: 20px;"></i></h1>
    <p style="font-family: Alata, sans-serif;text-align: center;color: var(--yellow);font-size: 18px;border-bottom-width: 0.8px;border-bottom-style: none;font-size: 14px;">Enjoy local movies or Stories&nbsp;<span style="color: rgb(255,22,7);"><span style="text-decoration: underline;">Stream&nbsp;</span><i class="fas fa-play-circle" style="color: #e41025;"></i></span>&nbsp; OR&nbsp;<span style="color: #2595ae;"><span style="text-decoration: underline;">Download&nbsp;</span><i class="fas fa-cloud-download-alt" style="color: #2595ae;"></i></span></p>
    <div class="container">
        <nav class="navbar navbar-light navbar-expand navigation-clean" style="background: url(&quot;assets/img/pad.png&quot;);">
            <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-1">
                    <ul class="navbar-nav mr-auto">
                        <li class="nav-item"><a class="nav-link disabled" href="#" style="color: rgb(255,255,255);font-family: Alata, sans-serif;">Genre</a></li>
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#" style="color: rgb(255,255,255);font-family: Alata, sans-serif;">All</a>
                            <div class="dropdown-menu" style="font-family: Alata, sans-serif;">
                            <a class="dropdown-item" href="cat.php?edt=<?php echo 'Action'?>">Action</a>
                            <a class="dropdown-item" href="cat.php?edt=<?php echo 'Romance'?>">Romance</a>
                            <a class="dropdown-item" href="cat.php?edt=<?php echo 'Comedy'?>">Comedy</a>
                            <a class="dropdown-item" href="cat.php?edt=<?php echo 'Horror'?>">Horror</a>
                            <a class="dropdown-item" href="cat.php?edt=<?php echo 'Drama'?>">Drama</a></div>
                        </li>
                        <li class="nav-item"><a class="nav-link disabled" href="#" style="color: rgb(255,255,255);font-family: Alata, sans-serif;">Year</a></li>
                        <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false" data-toggle="dropdown" href="#" style="font-family: Alata, sans-serif;color: rgb(255,255,255);">All</a>
                            <div class="dropdown-menu" style="font-family: Alata, sans-serif;font-size:12px;">
                            <a class="dropdown-item" href="y-filter.php?edt=<?php echo '2018 and 2021'?>">2018-2021</a>
                            <a class="dropdown-item" href="y-filter.php?edt=<?php echo '2015 and 2017'?>">2015-2017</a>
                            <a class="dropdown-item" href="y-filter.php?edt=<?php echo '2010 and 2016'?>">2010-2016</a>
                            <a class="dropdown-item" href="y-filter.php?edt=<?php echo '2000 and 2009'?>">2000-2009</a>
                            <a class="dropdown-item" href="y-filter.php?edt=<?php echo '1988 and 1999'?>">1988-1999</a>
                        </div>
                        </li>
                    </ul>
                </div>
            ...
            <div class="container"><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-2"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navcol-2">
                    ...
                    <div class="float-left float-md-right mt-5 mt-md-0 search-area">
                        <i class="fas fa-search float-left search-icon" style="color: var(--yellow);font-size:12px;"></i>
                        <input class="float-left float-sm-right custom-search-input" type="search" name="search" required="" placeholder="Type to filter by address" style="border-bottom-color: var(--yellow);font-family: Alata, sans-serif;color: var(--yellow);font-size:12px;"></div>
        ...
        <ul class="list-inline text-center">
		   <?php
            ...
            <li class="list-inline-item">
                <picture><img src="data:image/jpeg;charset=utf8;base64,<?php echo base64_encode ($rows['image']);?>" style="border-radius: 1px;height: 150px;width: 125px;"></picture><br><a href="view-movie.php?edt=<?php echo $rows['movie_id'] ?>" style="font-family: Alata, sans-serif;color: var(--yellow);font-size: 13px;"><?php echo $rows['title'].'-'.$rows['year'] ?><br></a>
            </li>
			            <?php
...
<?php
                ...
                ?>
                <h3 style="color:var(--yellow);text-align:center;">No Movies added.</h3>
                <?php
              } ?>
    ...
    <div class="container" style="text-align:center">
        <p class="text-center" style="font-family: Alata, sans-serif;"><div style='padding: 10px 20px 0px; border-top: dotted 0px #CCC;'>
